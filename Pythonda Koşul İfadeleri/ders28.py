#1- Kullanııcıdan isim,yaş ve eğitim bilgilerini isteyip ehliyet alabilme durumunu kontrol ediniz.Ehliyet alma koşulu en az 18 ve eğitim durumu lise ya da üniversite olmalıdır.
...
#3- Trafiğer çıkış tarihi alınan bir aracın servis zamanını aşağıdaki bilgilere göre hesaplayınızç
#   1.Bakım => 1.yıl
#   2.Bakım => 2.yıl
#   3.Bakım => 3.yıl
