...
q4 = Question('En sevilen programlama dili hangisidir?',['JavaScript','C#','Python','Java'],'Python')
q5 = Question('En kolayn programlama dili hangisidir?',['JavaScript','C#','Python','Java'],'Python')
